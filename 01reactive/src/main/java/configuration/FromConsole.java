...
// Lese Eingaben des Sensors aus Konsole aus
// Konfiguration durch Properties-File "fromConsole.properties"
public class FromConsole implements IConfiguration {
    ...
    private final String FROM_CONSOLE_PROPERTIES_KEY = "fromConsole.properties";
    ...
    private void loadPropertiesFile() {
        prop = new Properties();
        try (InputStream input = FromConsole.class.getClassLoader().getResourceAsStream(FROM_CONSOLE_PROPERTIES_KEY)){
            prop.load(input);
